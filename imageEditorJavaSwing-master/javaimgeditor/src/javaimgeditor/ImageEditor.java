...
public class ImageEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonBrowsImage.setFont(new java.awt.Font("Times New Roman", 1, 14));
        jButtonBrowsImage.setText("Встановити зображення");
        jButtonBrowsImage.setBackground(Color.CYAN);
        ...
        jLabel1.setFont(new java.awt.Font("Times New Roman", 4, 16)); // NOI18N
        jLabel1.setBackground(Color.BLACK);
        jLabel1.setText("Інструменти ефектів:");

        jButtonBlur1.setText("Ефект розмиття");
        jButtonBlur1.setBackground(Color.CYAN);
        ...
        jButtonDarken1.setText("Яскравість -");
        jButtonDarken1.setBackground(Color.CYAN);
        ...
        jButtonLighten2.setText("+ Яскравість");
        jButtonLighten2.setBackground(Color.CYAN);
        ...
        jButtonInvert3.setText("Ефект перевертання");
        jButtonInvert3.setBackground(Color.CYAN);
        ...
        jButtonSave5.setFont(new java.awt.Font("Times New Roman", 1, 14));
        jButtonSave5.setText("Зберегти зображення");
        jButtonSave5.setBackground(Color.CYAN);
        ...
        jLabel2.setText("Інструменти розміру:");

        jButtonCircleCrop1.setText("Змінити в коло");
        jButtonCircleCrop1.setBackground(Color.CYAN);
        ...
        jButtonRectangleCrop2.setText("Змінити в прямокутник");
        jButtonRectangleCrop2.setBackground(Color.CYAN);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jButtonRectangleCrop2, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonBlur1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBlur1ActionPerformed
        if(Circled == true)
        {
            BufferedImage BlurImg = new BufferedImage(circle.getWidth(null),circle.getHeight(null),BufferedImage.TYPE_USHORT_GRAY);
        ...
        {
            BufferedImage BlurImg = new BufferedImage(flippedImg.getWidth(null),flippedImg.getHeight(null),BufferedImage.TYPE_USHORT_GRAY);
            Graphics g1 = BlurImg.getGraphics();
            ...
            BufferedImage BlurImg = new BufferedImage(bimg.getWidth(null),bimg.getHeight(null),BufferedImage.TYPE_USHORT_GRAY);
            Graphics g1 = BlurImg.getGraphics();
