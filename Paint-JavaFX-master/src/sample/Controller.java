...
public class Controller {
    ...
    public void saveFromFile(){
        ...
        fileChooser.setTitle("Виберіть директорію для збереження...");
        fileChooser.setInitialFileName("new_image");
        fileChooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Зображення", "*.png"));
    ...
    public void menuExit() {
        if(isSave){
            ...
            alert.setContentText("Ви не збереглись. Зберегти проект перед виходом?");
